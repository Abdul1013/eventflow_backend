...
// expo-camera v14.1.3: Camera class with static useCameraPermissions hook
...
export default function ScannerScreen() {
  ...
  // Static hook on the Camera class —
  ...
  // ── Network state 
  // expo-network v6 doesn't ship a useNetworkState hook; poll getNetworkStateAsync instead
  ...
  // stats.tsx "Open Event Selector" CTA emits this — open our bottom sheet
  useEffect(() => {
  ...
  // networkListener emits this after a successful offline sync — refresh the stats bar
  useEffect(() => {
  ...
  const handleOverlayDismiss = useCallback(() => {
    ...
    // 2s debounce window before accepting the next scan
  ...
  return (
    <View style={styles.root}>
      ...
      {/* ── Offline banner (amber strip below stats bar) ───────────────────── */}
